...
static void renderSceneCallBack()
{
    ...
    //deltay += 0.005f;
    trans = translate(mat4(1.0f), vec3(0.0f, deltay, 0.0f));

    static float roty = 0.0f;
    roty += 0.5f;
    rot = rotate(mat4(1.0f), roty, vec3(0.0f, 1.0f, 0.0f));

    sca = scale(mat4(1.0f), vec3(0.2f, 0.2f, 1.0f));

    transform = rot * trans * sca;
    glUniformMatrix4fv(gTransformLocation, 1, GL_FALSE, &transform[0][0]);
